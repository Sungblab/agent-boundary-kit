...
The plan-only dry-run CLI contract is recorded in `docs/hook-runner-dry-run-cli-contract.md`. It defines a future command shape for printing scanner selection plans without executing scanners. It is still not an installed hook.
