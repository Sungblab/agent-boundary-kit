...
const cases = [
  ...
  {
    name: "approved file mask finding",
    input: "hooks/claude/examples/runner-scan.approved-file-mask-finding-input.json",
    expectedHookId: "post_edit_scope_check",
    scanner: "approved-file-mask-scan",
    expectedScanner: "approved-file-mask-scan",
    expected: "hooks/claude/examples/runner-scan.approved-file-mask-finding-output.json",
    exitCode: 1,
  },
  {
    name: "approved file mask clear",
    input: "hooks/claude/examples/runner-scan.approved-file-mask-clear-input.json",
    expectedHookId: "post_edit_scope_check",
    scanner: "approved-file-mask-scan",
    expectedScanner: "approved-file-mask-scan",
    expected: "hooks/claude/examples/runner-scan.approved-file-mask-clear-output.json",
    exitCode: 0,
  },
  {
    name: "research mode no-write finding",
    input: "hooks/claude/examples/runner-scan.research-mode-no-write-finding-input.json",
    expectedHookId: "post_edit_scope_check",
    scanner: "research-mode-no-write-scan",
    expectedScanner: "research-mode-no-write-scan",
    expected: "hooks/claude/examples/runner-scan.research-mode-no-write-finding-output.json",
    exitCode: 1,
  },
  {
    name: "research mode no-write clear",
    input: "hooks/claude/examples/runner-scan.research-mode-no-write-clear-input.json",
    expectedHookId: "post_edit_scope_check",
    scanner: "research-mode-no-write-scan",
    expectedScanner: "research-mode-no-write-scan",
    expected: "hooks/claude/examples/runner-scan.research-mode-no-write-clear-output.json",
    exitCode: 0,
  },
  {
