...
- `hooks/claude/examples/runner-scan.untrusted-context-post-edit-finding-input.json`
...
- `hooks/claude/examples/runner-scan.phase-gate-pre-write-finding-input.json`
- `hooks/claude/examples/runner-scan.phase-gate-pre-write-clear-input.json`
- `hooks/claude/examples/runner-scan.phase-gate-completion-finding-input.json`
- `hooks/claude/examples/runner-scan.phase-gate-completion-clear-input.json`
...
- `hooks/claude/examples/runner-scan.untrusted-context-post-edit-finding-output.json`
...
- `hooks/claude/examples/runner-scan.phase-gate-pre-write-finding-output.json`
- `hooks/claude/examples/runner-scan.phase-gate-pre-write-clear-output.json`
- `hooks/claude/examples/runner-scan.phase-gate-completion-finding-output.json`
- `hooks/claude/examples/runner-scan.phase-gate-completion-clear-output.json`
...
For `research-mode-no-write-scan`, it must pass only `--repo-root` from the declared runner input. `task` metadata selects the scanner and records no-write context; it must not be scanned as output evidence or used to infer broad workspace paths.
...
For `phase-gate-plan-scan`, it must pass explicit files from `inputs.metadataFiles`, resolved under the declared `repoRoot` when present. `task` metadata selects the scanner and records planning or completion context; it must not be scanned as a plan artifact or used to infer missing plan files.
