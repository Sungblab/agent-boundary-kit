...
The Claude hook settings-fragment review is recorded in `docs/claude-hook-settings-fragment-review.md`. Its check is `benchmarks/scripts/check-claude-hook-settings-fragment-review.js`, which keeps the wrapper-backed settings candidate review-only, user-approved, and non-mutating.

The Claude hook user-approved manual install language is recorded in `docs/claude-hook-user-approved-install-language.md`. Its check is `benchmarks/scripts/check-claude-hook-user-approved-install-language.js`, which keeps install language non-mutating and avoids direct settings paths or shell copy commands.

The Claude hook install application contract is recorded in `docs/claude-hook-install-application-contract.md`. Its check is `benchmarks/scripts/check-claude-hook-install-application-contract.js`, which blocks generic continuation commands from authorizing settings mutation.

The Claude hook user-owned target checklist is recorded in `docs/claude-hook-user-owned-target-checklist.md`. Its check is `benchmarks/scripts/check-claude-hook-user-owned-target-checklist.js`, which blocks repository targets, missing backup evidence, and agent-applied settings even after an explicit install request.

The Claude hook user-owned target review evidence is recorded in `docs/claude-hook-user-owned-target-review-evidence.md`. Its check is `benchmarks/scripts/check-claude-hook-user-owned-target-review-evidence.js`, which keeps target review evidence separate from settings application and blocks generic continuation text.

The Claude hook user-owned target review packet is recorded in `docs/claude-hook-user-owned-target-review-packet.md`. Its check is `benchmarks/scripts/check-claude-hook-user-owned-target-review-packet.js`, which keeps target review packets review-only and rejects agent-applied settings.
...
The Claude hook wrapper output fixtures are recorded in `docs/claude-hook-wrapper-output-fixtures.md`. Their check is `benchmarks/scripts/check-claude-hook-wrapper-output-fixtures.js`, which fixes the expected native-payload-with-carrier envelope while keeping the wrapper not implemented by the current entrypoint.
...
The Claude hook wrapper wiring review is recorded in `docs/claude-hook-wrapper-wiring-review.md`. Its check is `benchmarks/scripts/check-claude-hook-wrapper-wiring-review.js`, which verifies wrapper output feeds the existing native command entrypoint without installing hooks, running scanners, or publishing live settings guidance.
...
The Claude hook command adapter implementation contract is recorded in `docs/claude-hook-command-adapter-implementation-contract.md`. Its check is `benchmarks/scripts/check-claude-hook-command-adapter-implementation-contract.js`, which bounds the stdin entrypoint implementation.

The Claude hook command adapter entrypoint fixtures are recorded in `docs/claude-hook-command-adapter-entrypoint-fixtures.md`. Their check is `benchmarks/scripts/check-claude-hook-command-adapter-entrypoint-fixtures.js`, which fixes stdin parsing, cleanup, exit-code, and rejection expectations.

The Claude hook command adapter entrypoint is recorded in `docs/claude-hook-command-adapter-entrypoint.md`. Its check is `benchmarks/scripts/check-claude-hook-command-adapter-entrypoint.js`, which verifies the local `abk-claude-hook` stdin adapter without installing hooks.
...
95. Add Claude hook native payload mapping fixtures. Completed: `docs/claude-hook-native-payload-mapping-fixtures.md`.
96. Add a Claude hook native payload mapping fixture check. Completed: `benchmarks/scripts/check-claude-hook-native-payload-mapping-fixtures.js`.
97. Add Claude hook native metadata carrier fixtures. Completed: `docs/claude-hook-native-metadata-carrier-fixtures.md`.
98. Add a Claude hook native metadata carrier fixture check. Completed: `benchmarks/scripts/check-claude-hook-native-metadata-carrier-fixtures.js`.
99. Add a Claude hook command adapter contract. Completed: `docs/claude-hook-command-adapter-contract.md`.
100. Add a Claude hook command adapter contract check. Completed: `benchmarks/scripts/check-claude-hook-command-adapter-contract.js`.
101. Add Claude hook command adapter red/green fixtures. Completed: `docs/claude-hook-command-adapter-fixtures.md`.
102. Add a Claude hook command adapter fixture check. Completed: `benchmarks/scripts/check-claude-hook-command-adapter-fixtures.js`.
103. Add a Claude hook command adapter implementation contract. Completed: `docs/claude-hook-command-adapter-implementation-contract.md`.
104. Add a Claude hook command adapter implementation contract check. Completed: `benchmarks/scripts/check-claude-hook-command-adapter-implementation-contract.js`.
105. Add Claude hook command adapter entrypoint fixtures. Completed: `docs/claude-hook-command-adapter-entrypoint-fixtures.md`.
...
122. Add a Claude hook wrapper input contract. Completed: `docs/claude-hook-wrapper-input-contract.md`.
123. Add a Claude hook wrapper input contract check. Completed: `benchmarks/scripts/check-claude-hook-wrapper-input-contract.js`.
124. Add Claude hook wrapper output fixtures. Completed: `docs/claude-hook-wrapper-output-fixtures.md`.
