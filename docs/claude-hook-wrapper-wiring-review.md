...
User-approved install language is recorded later in `docs/claude-hook-user-approved-install-language.md` and checked by `benchmarks/scripts/check-claude-hook-user-approved-install-language.js`.
