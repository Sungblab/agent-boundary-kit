...
- the wrapper output fixture is expected-output-only
...
The next gate is a wrapper implementation contract, still non-mutating and still separate from any agent-performed installation.
