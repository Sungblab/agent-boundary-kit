...
The next gate is recorded in `docs/claude-hook-user-execution-packet-review-contract.md`: user execution packet review. It still does not apply settings, install hooks, or mutate Claude configuration.

That gate is checked by `benchmarks/scripts/check-claude-hook-user-execution-packet-review-contract.js`.
