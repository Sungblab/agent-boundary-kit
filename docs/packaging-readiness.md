...
Claude hook packaging remains later because hooks still need a bounded mapper implementation with passing output fixtures and must not read private transcripts.
