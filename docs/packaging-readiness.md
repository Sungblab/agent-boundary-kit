...
The Claude hook application boundary chain is recorded in `docs/claude-hook-application-boundary-chain.md`.
...
The Claude hook application boundary chain check is `benchmarks/scripts/check-claude-hook-application-boundary-chain.js`. It verifies `docs/claude-hook-application-boundary-chain.md` records the ordered non-mutating chain through terminal boundary.
