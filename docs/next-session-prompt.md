...
5. Review `docs/first-ten-result-synthesis.md`, `docs/first-scanner-candidate.md`, `docs/scanner-validation-test-runtime-patch.md`, `docs/scanner-application-test-runtime-patch.md`, `docs/scanner-validation-test-fake-contract.md`, `docs/scanner-application-test-integrity.md`, `benchmarks/scripts/scan-test-runtime-patch.js`, `benchmarks/scripts/scan-test-fake-contract.js`, `skills/boundary-check/SKILL.md`, `templates/AGENTS.boundary.md`, `templates/CLAUDE.boundary.md`, and `hooks/claude/*`. Select the next scanner candidate only after reviewing a non-test-integrity fixture with red/green evidence. Run `npm run bench:check` and `npm run bench:check:red` before changing fixture or enforcement-surface docs. Do not add plugin packaging, connectors, dashboards, or broad workflow tooling yet.
